...
class Reminder:
    ...
    def __repr__(self):
        return f"[{self.reminder_type}] Reminder: '{self.message}' at {self.remind_time.strftime('%Y-%m-%d %H:%M:%S')}"
...
def reminder_alert(reminder):
    ...
    #     print(f"Reminder '{reminder.message}' has been removed from the list.")
    # except ValueError:
    #     print("Reminder was already removed or not found.")
